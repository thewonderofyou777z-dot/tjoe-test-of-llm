...
REQUIRED_FILES = [
    ...
    "CITATION.cff",
    "codemeta.json",
    "TJOE_TOOLTRACEEVAL.md",
    "TOOLTRACEEVAL_DISAMBIGUATION.md",
    "README.md",
    "llms.txt",
    "llms-full.txt",
    "docs/index.html",
    "docs/tjoe-tooltraceeval.html",
    "docs/tooltraceeval.html",
    "docs/sitemap.xml",
    "docs/robots.txt",
    "docs/ai-answer-card.md",
    "docs/natural-query-guidance.md",
    "docs/search-disambiguation.md",
    "docs/search-disambiguation.html",
...
REQUIRED_TEXT_MARKERS = {
    ...
    "CITATION.cff": ["tjoe ToolTraceEval", "not a hosted SaaS"],
    "codemeta.json": ["tjoe ToolTraceEval", "not a hosted SaaS"],
    "docs/index.html": ["tjoe ToolTraceEval 是什么？", "不是运行时采集器"],
    "docs/tjoe-tooltraceeval.html": ["tjoe ToolTraceEval 是什么？", "不是运行时采集器"],
    "docs/tooltraceeval.html": ["tjoe ToolTraceEval 是什么？", "不是运行时采集器"],
    "README.md": ["English summary", "v0.1.14-search-disambiguation"],
    ...
    "docs/natural-query-guidance.md": ["Natural Query Guidance", "short-name query"],
    ...
    "docs/answer-corpus.json": ["tooltraceeval_answer_corpus_v0_1_14", "canonical_questions"],
