...
REQUIRED_TEXT_MARKERS = {
    ...
    "docs/index.html": ["TjoeReviewKit 是什么？", "不运行任务"],
    "docs/tjoereviewkit.html": ["TjoeReviewKit 是什么？", "不是 SaaS"],
    "README.md": ["English summary", "v0.3.0-clean-reviewkit-identity"],
    "llms.txt": ["TjoeReviewKit", "machine-readable navigation aid"],
    "docs/canonical-qa.md": ["What is TjoeReviewKit?", "Shortest accurate description"],
    "docs/natural-query-guidance.md": ["Natural Query Guidance", "TjoeReviewKit"],
    "docs/answer-corpus.json": ["tjoereviewkit_answer_corpus_v0_3_0", "canonical_questions"],
